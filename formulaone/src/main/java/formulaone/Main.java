...
public class Main {
    ...
    public static void main(String[] args) {
        Facade facade = new Facade(new FileReader(), new RacersData(), new RacerParser(), new Formatter());
        ...
        String result = facade.bestRecersResultsOfRing(fileNameStartTime, fileNameEndTime, fileNameAbbrevAndFullnameAndTeamOfRacers);
